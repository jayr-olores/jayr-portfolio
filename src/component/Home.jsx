function Home() {
  return (
    <section
      id="home"
      className="w-11/12 md:w-4/5 mx-auto py-12 md:py-20 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-center"
    >
      {/* Left: Text */}
      <div className="space-y-6 text-center md:text-left">
        {/* Large Heading */}
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-black leading-tight">
          I’m <span className="text-[#008cff]">Jay-r</span>
        </h1>
      ...
      <div className="flex justify-center order-first md:order-none">
        <div className="w-40 h-40 sm:w-56 sm:h-56 md:w-80 md:h-80 bg-gray-100 rounded-xl shadow flex items-center justify-center">
          {/* Replace with <img src="..." alt="hero" /> */}
          <span className="text-[#828282] text-sm sm:text-base">[ Image Area ]</span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6 w-full max-w-sm mx-auto md:mx-0">
        <div className="bg-white shadow-lg hover:shadow-xl hover:-translate-y-1 transition transform rounded-2xl p-6 border border-gray-100">
          <h3 className="text-lg sm:text-xl font-semibold text-black mb-2">Card Title 1</h3>
          <p className="text-[#828282] text-sm sm:text-base">
            Short description or feature info goes here.
          </p>
        </div>
        <div className="bg-white shadow-lg hover:shadow-xl hover:-translate-y-1 transition transform rounded-2xl p-6 border border-gray-100">
          <h3 className="text-lg sm:text-xl font-semibold text-black mb-2">Card Title 2</h3>
          <p className="text-[#828282] text-sm sm:text-base">
